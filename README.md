...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/target-risk.svg?v=0.6.4" alt="R_tgt(f) = E_{(X,Y)~P_tgt}[ell(Y, f(X))]">
</p>

If only reference labels are abundant, the naive reference estimate

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/reference-risk-estimator.svg?v=0.6.4" alt="(1 / n) sum_i ell(y_i, f(x_i))">
</p>

can be biased for the target population. Under covariate shift,

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/covariate-shift-assumption.svg?v=0.6.4" alt="P_ref(Y | X) = P_tgt(Y | X), P_ref(X) != P_tgt(X)">
</p>

the target risk can be estimated with density-ratio weights:

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/density-ratio.svg?v=0.6.4" alt="w(x) = p_tgt(x) / p_ref(x)">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/weighted-target-risk.svg?v=0.6.4" alt="R_tgt(f) = E_{P_ref}[w(X) ell(Y, f(X))]">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/domain-posterior.svg?v=0.6.4" alt="d(x) = P(D = target | X = x)">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/domain-density-ratio.svg?v=0.6.4" alt="w(x) = d(x) / (1 - d(x)) times pi_ref / pi_tgt">
</p>

The weighted empirical risk is then

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/weighted-empirical-risk.svg?v=0.6.4" alt="R_hat_w(f) = sum_i w_i ell(y_i, f(x_i)) / sum_i w_i">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/kish-effective-sample-size.svg?v=0.6.4" alt="n_eff = (sum_i w_i)^2 / sum_i w_i^2">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/ece.svg?v=0.6.4" alt="ECE = sum_k |B_k| / n times |mean_{i in B_k}(p_i) - mean_{i in B_k}(y_i)|">
</p>

The weighted version replaces counts and means with weighted mass:

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/weighted-ece.svg?v=0.6.4" alt="ECE_w = sum_k W_k / W times |avg_w(p_i | i in B_k) - avg_w(y_i | i in B_k)|">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/acceptance-function.svg?v=0.6.4" alt="phi(x) in {0, 1}">
</p>

The accepted-set target risk is

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/selective-risk.svg?v=0.6.4" alt="R_tgt(f, phi) = E_tgt[phi(X) ell(Y, f(X))] / E_tgt[phi(X)]">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/selective-coverage.svg?v=0.6.4" alt="coverage(phi) = E_tgt[phi(X)]">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/weighted-residual-gap.svg?v=0.6.4" alt="g_c = avg_w(y_i - p_i | i in c)">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/simultaneous-radius.svg?v=0.6.4" alt="r_c = sqrt(log(2K / alpha) / (2 n_eff,c))">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MehdiOudghiri1/shiftstat/main/docs/assets/equations/certified-excess.svg?v=0.6.4" alt="excess_c = max(|g_c| - r_c - rho_c - gamma - tau, 0)">
</p>
